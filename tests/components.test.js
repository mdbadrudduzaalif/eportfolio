...
it("renders <secure-email> correctly and decodes base64 email", () => {
  const secureEmailComp = document.createElement("secure-email");
  // 'test@example.com' encoded in base64 is 'dGVzdEBleGFtcGxlLmNvbQ=='
  secureEmailComp.setAttribute("data-email", "dGVzdEBleGFtcGxlLmNvbQ==");
  document.body.appendChild(secureEmailComp);

  const link = secureEmailComp.querySelector("a");
